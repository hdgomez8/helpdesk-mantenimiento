...
$(document).ready(function () {
  ...
  if ($("#rol_idx").val() == 1) {
    ...
    $.post("../../controller/ticket.php?op=totalxgestionar", function (data) {
      data = JSON.parse(data);
      $("#lbltotalxgestionarnavadmin").html(data.TOTAL);
    });

    $.post("../../controller/ticket.php?op=totalxRealizarTecnicoJefe",{ usu_id: usu_id }, function (data) {
      data = JSON.parse(data);
      $("#lbltotalxrealizartecnicosadmin").html(data.TOTAL);
    });

    $.post("../../controller/ticket.php?op=totalxrealizarproveedores",{ usu_id: usu_id }, function (data) {
      data = JSON.parse(data);
      $("#lbltotalxrealizarproveedoresadmin").html(data.TOTAL);
    });

    $.post("../../controller/ticket.php?op=totalxmateriales", function (data) {
      data = JSON.parse(data);
      $("#lbltotalpendientesxmaterialesadmin").html(data.TOTAL);
    });
    ...
    $.post(
      ...
      function (data) {
        data = JSON.parse(data);
        $("#lbltotalpendientesencomprasadmin").html(data.TOTAL);
      }
    );
    ...
    $.post(
      ...
      function (data) {
        data = JSON.parse(data);
        $("#lbltotalpendientesconmaterialesadmin").html(data.TOTAL);
      }
    );

    $.post("../../controller/ticket.php?op=totalxvistobueno", function (data) {
      data = JSON.parse(data);
      $("#lbltotalpendientesparavistobuenoadmin").html(data.TOTAL);
    });

    $.post("../../controller/ticket.php?op=totalxcerrar", function (data) {
      data = JSON.parse(data);
      $("#lbltotalpendientescierrejefeadmin").html(data.TOTAL);
    });
