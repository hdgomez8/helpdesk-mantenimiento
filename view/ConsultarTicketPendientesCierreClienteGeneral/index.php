...
?>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				...
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Solicitudes Pendientes por Visto Bueno</h3>
								<input type="hidden" id="dir_proyecto" value="<?php echo $dir_proyecto; ?>">
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="../Home">Inicio</a></li>
									<li class="active">Solicitudes Pendientes por Visto Bueno</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="ConsultarTicketPendientesCierreClienteGeneral.js"></script>
