...
?>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				...
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Solicitudes Pendientes Por Materiales</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="../Home">Inicio</a></li>
									<li class="active">Solicitudes Pendientes Por Materiales</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="ConsultarTicketPendientesCompras.js"></script>
