...
$(document).ready(function () {
  ...
  /* TODO: Filtro avanzado en caso de ser Admin */
  ...
  if (rol_id == 1) {
    ...
    listardatatablehelper(
      "#ticket_data",
      "op=listar_x_est_con_materiales",
      0,
      "desc",
      datosAdicionales
    );
    ...
    listardatatablehelper(
      "#ticket_data",
      "op=listar_x_est_con_materiales_tecnico",
      0,
      "desc",
      datosAdicionales
    );
...
function listardatatable(usu_asig) {
  tabla = $("#ticket_data")
    .dataTable({
      aProcessing: true,
      aServerSide: true,
      ...
      ajax: {
        url: "../../controller/ticket.php?op=listar_x_est_con_materiales",
        type: "post",
        dataType: "json",
